...
function App() {
  ...
  //State = Whose state? 
  //Dispatch will call reducer with a action as parameter
    ...
    <div className='container'>
      <div className="calculator-grid">
        <div className="result-display">
          <div className="first-operator">{prevOperand} {operation}</div>
          <div className="second-operator">{currentOperand}</div>
        </div>
